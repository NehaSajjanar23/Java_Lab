...
public class Bank {
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("\nChoose an operation: 1: Deposit, 2: Withdraw, 3: Display Balance, 4: Compute and Deposit Interest (Savings Account only), 5: Exit");
            int op = sc.nextInt();
            ...
            switch (op) {
                ...
                case 4:
                    if (account instanceof SavAcct) {
                        ...
                        System.out.println("Interest computation is only available for Savings Account.");
                    }
                    break;
                case 5:
